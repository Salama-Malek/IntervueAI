...
export function SessionViewerModal({ session, onClose }: SessionViewerModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center text-white">
      ...
      <div className="relative z-10 max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#13021c] via-[#08020f] to-[#020106] shadow-[0_30px_120px_rgba(0,0,0,0.7)]">
